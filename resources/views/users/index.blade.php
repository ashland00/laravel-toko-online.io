                        ...
                        <br>
                            <table class="table table-bordered text-center">
                                ...
                                @foreach($users as $user)
                                    ...
                                    <td>
                                        <a class="btn btn-outline-info btn-sm" href="{{route('users.edit', ['id'=>$user->id])}}">Edit</a>
                                        <a href="{{route('users.show', ['id' => $user->id])}}" class="btn btn-outline-primary btn-sm">Detail</a>
